...
var ImportSelector = Class.create( {
  ...
  initialize: function() {
    ...
    var promptImport = new Element('div', {'class': 'import-section'}).update(i18n.t('import.pasteData') + ':');
    ...
    buttons.insert(new Element('input', {type: 'button', name : 'import', 'value': i18n.t('menu.import'), 'class' : 'button', 'id': 'import_button'}).wrap('span', {'class' : 'buttonwrapper'}));
    ...
    this.dialog = new PedigreePro.widgets.ModalPopup(mainDiv, {close: {method : this.hide.bind(this), keys : closeShortcut}}, {extraClassName: 'pedigree-import-chooser', title: i18n.t('import.modalTitle'), displayCloseButton: true});
  },
  ...
  _onImportStarted: function() {
    ...
    if (!importValue || importValue == '') {
      alert(i18n.t('dialog.nothingToImport'));
      return;
    }
  ...
  updateLanguage: function() {
    ...
    if (this.importButton) {
      this.importButton.value = i18n.t('menu.import');
    }
  }
});
